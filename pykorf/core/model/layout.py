...
class LayoutService:
    ...
    def snap_orthogonal(self, threshold_deg: float = 10.0) -> None:
        ...
        pairs = self.model._connectivity_service.get_connected_pairs()
    ...
    def route_pipe(self, pipe: BaseElement, bend: str = "auto") -> None:
        ...
        """
        pipe_to_elems = self.model._connectivity_service.get_pipe_to_elems()
    ...
    def ensure_title(
        ...
        Example:
            ```python
            model._layout_service.ensure_title("My Process Model")
            model._layout_service.ensure_title()
            ```
        """
