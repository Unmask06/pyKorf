...
class ElementService:
    ...
    def _position_pipe_between(self, pipe_name: str, elem1_name: str, elem2_name: str) -> None:
        ...
        if pos1 is None or pos2 is None or pos1 == (0.0, 0.0) or pos2 == (0.0, 0.0):
            self.model._layout_service.auto_place(pipe)
            return
        ...
        from pykorf.core.model.layout import MIN_SPACING

        x_min, y_min, x_max, y_max = self.model._layout_service.boundary_coordinates
