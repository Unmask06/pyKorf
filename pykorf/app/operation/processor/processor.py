...
from pykorf.app.operation.data_import.hmb import apply_hmb, load_hmb
...
class PipedataProcessor:
    ...
    def load_pms(self, source: Path | str) -> None:
        ...
        """
        from pykorf.app.operation.data_import.pms import load_all_pms
    ...
    def _process_pipe(self, pipe: Any) -> PipeUpdateResult:
        ...
        if self._hmb_data is not None and stream_no:
            from pykorf.app.operation.data_import.hmb import lookup_stream
