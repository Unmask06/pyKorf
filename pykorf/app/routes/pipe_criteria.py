...
def _render_page(
    ...
    from pykorf.app.operation.integration.sizing_criteria import FLUID_LABELS
...
def pipe_criteria():
    ...
    from pykorf.app.operation.project.pykorf_file import get_pipe_criteria, set_pipe_criteria
    from pykorf.app.operation.integration.sizing_criteria import all_codes_by_type
