        ...
        <div class="pk-card-body">
          ...
          <div class="mb-3">
            ...
            <div class="flex">
              ...
              <input
                ...
                type="text"
                list="pipe-datalist"
                class="pk-input-mono rounded-none"
                placeholder="Type pipe name..."
                autocomplete="off"
                @focus="activeField = 'ref'"
          ...
          <div class="mb-3">
            ...
            <div class="flex">
              ...
              <input
                ...
                type="text"
                class="pk-input-mono rounded-none"
                placeholder="Select the pipes from list"
                autocomplete="off"
          ...
          <div class="mb-3 flex items-center gap-2">
            ...
            <label for="exclude-check" class="text-sm cursor-pointer">
              <strong>Exclude mode</strong> — Copy to all pipes EXCEPT those
              listed
            </label>
          </div>
          ...
          <div class="flex gap-2">
            <button
              ...
              :disabled="copyLoading.isLoading.value"
            >
      ...
      <div class="pk-card">
        ...
        <div class="p-4 text-sm text-gray-500">
          <ol class="pl-4 space-y-1 mb-0">
            <li>
              Select a <strong>Reference pipe</strong> (source of fluid
              properties)
            </li>
            <li>Select <strong>Target pipes</strong> or leave empty for ALL</li>
            <li>
              Check <strong>Exclude</strong> to copy to all EXCEPT listed pipes
            </li>
