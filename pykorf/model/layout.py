...
def visualize(model: Model, **kwargs: Any) -> str:
...
class LayoutMixin:
    ...
    def check_layout(self) -> list[str]:
        ...
        return check_layout(self)  # type: ignore[attr-defined]

    def visualize(self, **kwargs: Any) -> str:
        """Create a text visualization of elements and connections."""
        return visualize(self, **kwargs)  # type: ignore[attr-defined]
    ...
    def auto_layout(self, spacing: float | None = None) -> None:
        ...
        for i, elem in enumerate(unplaced):
            ...
            set_position(self, elem.name, x, y)  # type: ignore[attr-defined]
            existing.append((x, y))
    ...
    def visualize_network(self, path: str | Path = "network.html") -> None:
        ...
        viz = Visualizer(self)  # type: ignore[attr-defined]
        viz.to_html(path)
