...
def test_file_picker_kdf_validation(tmp_path):
    ...
    with patch.object(FilePickerScreen, 'app', new_callable=MagicMock), \
        ...
        mock_error_label.update.assert_called_with("Invalid file type: .txt. Please select a .kdf file.")
